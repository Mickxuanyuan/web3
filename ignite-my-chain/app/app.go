...
import (
	...
	"ignite-my-chain/docs"
	ignitemychainmodulekeeper "ignite-my-chain/x/ignitemychain/keeper"
)

const (
	// Name is the name of the application.
	Name = "ignite-my-chain"
...
type App struct {
	*runtime.App
	...
	IgnitemychainKeeper ignitemychainmodulekeeper.Keeper
}
